    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //判断EditText框上的值是否为空
                if (uname.equals("") || uname == null || upassword.equals("") || upassword == null) {
                    Toast.makeText(me_user_login.this, "请输入完整信息！", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        HttpUtils.sendOkHttpRequest(url, userJsonStr, new okhttp3.Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {//回调的方法执行在子线程。
                    ...
                    final String pictureUrl = responseBO.getPictureUrl();
                    final int flag = responseBO.getFlag();
                    Log.i(TAG, "登录中成功获取flag==" + flag);
                    final String token = responseBO.getToken();
                    Log.i(TAG, "登陆中成功获取token==" + token);
                    final String userid = responseBO.getUserid();
