...
/**
 * 项目名称：com.ghl.wuhan.secondhand.adapter
 * 类描述：
 * 创建人：Liting
 * 创建时间：2019/9/13 10:59
 * 修改人：Liting
 * 修改时间：2019/9/13 10:59
 * 修改备注：
 * 版本：
 */
...
public class GoodsGridAdapter extends RecyclerView.Adapter<GoodsGridAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from( parent.getContext() ).inflate( R.layout.goods_item_grid,parent,false );
