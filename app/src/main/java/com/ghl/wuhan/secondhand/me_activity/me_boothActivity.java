...
public class me_boothActivity extends AppCompatActivity {
    ...
    public void init(){
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(me_boothActivity.this, 2);
                        ...
                        public void run() {
                            ...
                            if (flag == 200) {
                                ...
                                if (newResultGoodsList.size() <=0) {
                                    Toast.makeText(me_boothActivity.this, "没有更多内容了哦！", Toast.LENGTH_SHORT).show();
                                    return;
                                }
                                //上拉加载
                                if (checkType == 1) {
                                    ...
                                    GoodsGridAdapter adapter = new GoodsGridAdapter(me_boothActivity.this, allGoodsList);
