...
public class me_buyActivity extends AppCompatActivity {
    ...
    public void init(){
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(me_buyActivity.this, 2);
                        ...
                        public void run() {
                            ...
                            if (flag == 200) {
                                ...
                                if (checkType == 1) {
                                    ...
                                    GoodsGridAdapter adapter = new GoodsGridAdapter(me_buyActivity.this, allGoodsList);
